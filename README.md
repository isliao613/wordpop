...
給幼兒園大班孩子(5–6 歲)的英語啟蒙遊戲，涵蓋**聽、說、讀、寫、算、理解**六大面向,並含 ㄅㄆㄇ 注音，共 **35 個小遊戲**。真人發音優先、答錯永遠給鼓勵、大按鈕高對比、進度自動保存。

▶️ **線上遊玩**：<https://isliao613.github.io/wordpop/>

## ✨ 特色

- **35 個遊戲**，依能力分成 11 組：認識單字、聽聲音找字、聽懂句子、拼讀 Phonics、拼字與字母、ㄅㄆㄇ 注音、數字與算數、動動腦、故事與分類、常見字 Sight Words、開口與動手
- **ㄅㄆㄇ 注音**：37 個注音符號與例詞，使用裝置的中文(zh-TW)語音
