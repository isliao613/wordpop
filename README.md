...
給幼兒園大班孩子(5–6 歲)的英語啟蒙遊戲，涵蓋**聽、說、讀、寫、算、理解**六大面向,並含 ㄅㄆㄇ 注音，共 **42 個小遊戲**。真人發音優先、答錯永遠給鼓勵、大按鈕高對比、進度自動保存。

▶️ **線上遊玩**：<https://isliao613.github.io/wordpop/>

## ✨ 特色

- **42 個遊戲**，分成 ABC / ㄅㄆㄇ / 數字 三個科目分頁：認識單字、聽聲音找字、聽懂句子、拼讀 Phonics、拼字與字母、ㄅㄆㄇ 注音、數字與算數、動動腦、故事與分類、常見字 Sight Words、開口與動手
- **ㄅㄆㄇ 注音**：10 個遊戲對應 ABC 的玩法,涵蓋認符號、聽音、**拼音**(ㄍ+ㄡ=ㄍㄡ)、**聲調**、跟讀與手寫;使用裝置的中文(zh-TW)語音,手寫採**教育部標準筆順**
...
| ㄅ 注音 ㄅㄆㄇ | 認識注音、ㄅㄆㄇ 接接看、注音獵人、注音配對、注音泡泡、拼音小火車、聲調小老師、注音翻翻樂、注音跟讀、注音手寫 |
| 🔢 數字與算數 | 數字接龍、加加看 |
